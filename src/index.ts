...
import {defaultChainInfo, defaultChainUrl, MainnetChainUrl, TestnetChainInfo, TestnetChainUrl} from "./drand/defaults"
...
export function testnetClient(): HttpChainClient {
    const chain = new HttpCachingChain(TestnetChainUrl, defaultChainOptions)
...
export function mainnetClient(): HttpChainClient {
    ...
    const chain = new HttpCachingChain(MainnetChainUrl, opts)
